...
{
    internal sealed class ConverterViewModel : Presenter
    {
        private readonly ConverterModel _model;
        private string _someText = string.Empty;

        public ConverterViewModel(ConverterModel model, ObservableCollection<string> history) => (_model, History) = (model, history);
